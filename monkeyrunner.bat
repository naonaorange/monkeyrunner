...
rem Set up platform_tools directories
set platformtoolsdir=..\..\platform-tools
...
call "%java_exe%" -Xmx512m "-Djava.ext.dirs=%frameworkdir%;%swt_path%" -Dcom.android.monkeyrunner.bindir=%platformtoolsdir% -jar %jarpath% %*
